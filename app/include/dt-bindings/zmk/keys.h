...
#define KC_AT (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_AT))
// #define KC_AT 0xF001
#define KC_CARET (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_CARET))
#define KC_AMPERSAND (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_AMPERSAND))
#define KC_ASTERISK (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_ASTERISK))
#define KC_LEFT_PARENTHESIS (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_LEFT_PARENTHESIS))
#define KC_RIGHT_PARENTHESIS (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_RIGHT_PARENTHESIS))
#define KC_TILD (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_TILD))
#define KC_UNDER (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_UNDER))
#define KC_PLUS (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_PLUS))
#define KC_LBRC (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_LBRC))
#define KC_RBRC (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_RBRC))
#define KC_PIPE (ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_PIPE))
#define JPUS (ZMK_HID_USAGE(HID_USAGE_KEY, 0xF4))
#define KC_IME (ZMK_HID_USAGE(HID_USAGE_KEY, 0xF5))
#define KC_PER (ZMK_HID_USAGE(HID_USAGE_KEY, 0xF6))
#define KC_SET_PER (ZMK_HID_USAGE(HID_USAGE_KEY, 0xF7))